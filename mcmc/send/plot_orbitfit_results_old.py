...
pickle_filename = 'eri_test1_0.npz'
...
P = np.sqrt(chain[:,:,0]**3./1.75)*365.2425
...
labels=["a[AU]",r'$\tau$',r'$\omega[^{\circ}]$',r'$\Omega[^{\circ}]$',r'$i[^{\circ}]$',r'$e$']
...
plt2.errorbar(epochdt[0::2],xy[0::2],yerr=sig[1::2],fmt='ro',ecolor='k', elinewidth=2, capthick=2, ms=2)
